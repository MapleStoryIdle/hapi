export default {
  ...
  'recentCodex.sshControl.title': 'Controlled by Codex Desktop over SSH',
  'recentCodex.sshControl.detail': 'This transcript remains visible, but sending and archiving are locked until Codex Desktop releases this session.',
  'recentCodex.sshControl.sendLocked': 'Sending is locked while Codex Desktop controls this session',
