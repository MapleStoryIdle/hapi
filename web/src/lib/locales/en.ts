export default {
  ...
  'shares.hint': 'Each shared file is a task. A feedback-enabled Markdown task can receive an external agent response and safely send it back to its source session for review.',
  ...
  'shares.cleanupPending.title': 'Link revoked',
  'shares.cleanupPending.body': 'Public access is blocked. HAPI will retry removing the file from disk.',
  ...
  'shares.details.viewFeedback': 'View feedback',
  'shares.details.hideFeedback': 'Hide feedback',
  ...
  'shares.feedback.open': 'View feedback',
