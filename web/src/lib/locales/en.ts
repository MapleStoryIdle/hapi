export default {
  ...
  'shares.hint': 'Only active public files appear here. Select a file for details; newly created shares can copy their link.',
  'shares.loading': 'Loading shared files…',
  'shares.empty': 'No active shared files.',
  ...
  'recentCodex.direct.phase.queued.title': 'Message queued',
  'recentCodex.direct.phase.queued.detail': 'It will be delivered in order after the current Codex reply finishes.',
