export default {
  ...
  'sessions.running.hapi': 'HAPI sessions',
  ...
  'shares.empty': 'No active Kanban tasks.',
  ...
  'shares.details.tabsLabel': 'Kanban task details',
  ...
  'shares.toast.copyFailed.body': 'The link could not be copied. Try again from this task.',
  'shares.toast.revokeFailed.body': 'The public link is still active. Try again from this task.',
  'shares.toast.deliveryFailed.body': 'The feedback was not delivered. Try again from this task.',
  ...
  'shares.toast.feedbackUnreadable.body': 'Open this task to inspect the received file.',
  ...
  'recentCodex.source.hapi': 'HAPI Codex',
  'recentCodex.source.native': 'Native Codex',
  'recentCodex.status.hapiProcessing': 'HAPI Codex is running',
  ...
  'recentCodex.direct.error.externalWriter': 'This native session is open in another Codex client, so HAPI cannot send this message right now.',
  ...
  'recentCodex.fork.progress.body': 'Copying the original context into a new HAPI session…',
  ...
  'recentCodex.fork.error.hubUnavailable': 'HAPI is temporarily unavailable. Reconnect, then try again.',
  ...
  'tool.semanticTitle.manage-hapi': 'Manage HAPI',
  ...
  'taskStatus.retrying.body': 'HAPI will retry this message in the same conversation.',
  'taskStatus.retrying.bodyWithAttempt': 'HAPI will retry this message in the same conversation ({attempt}).',
  'taskStatus.compacting.title': 'Context is too large; compacting before retry',
  'taskStatus.compacting.body': 'HAPI is compacting the current conversation context, then it will retry.',
  'taskStatus.compacting.bodyWithAttempt': 'HAPI is compacting the current conversation context, then it will retry ({attempt}).',
