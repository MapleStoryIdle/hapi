export default {
  ...
  'recentCodex.direct.processing': 'This native Codex session is processing. Sending is locked until it finishes.',
  ...
  'recentCodex.status.processing.short': 'Running',
  ...
  'recentCodex.status.locked': 'Direct send and Fork are locked until this session is idle.',
