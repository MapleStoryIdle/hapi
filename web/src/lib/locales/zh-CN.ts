export default {
  ...
  'recentCodex.sshControl.title': '此会话正由 Codex Desktop SSH 控制',
  'recentCodex.sshControl.detail': '仍可查看转录内容；在 Codex Desktop 释放此会话前，发送和归档已锁定。',
  'recentCodex.sshControl.sendLocked': 'Codex Desktop 控制此会话期间无法发送',
