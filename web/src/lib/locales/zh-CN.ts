export default {
  ...
  'shares.title': '已分享文件',
  'shares.back': '返回会话列表',
  'shares.hint': '这里只显示还有效的公开文件。点击文件查看详情；之后新建的分享可复制链接。',
  'shares.loading': '正在读取已分享文件…',
  'shares.empty': '还没有有效的已分享文件。',
  ...
  'recentCodex.direct.phase.queued.title': '消息已排队',
  'recentCodex.direct.phase.queued.detail': '会在当前 Codex 回复结束后按顺序投递。',
