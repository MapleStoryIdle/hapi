export default {
  ...
  'shares.toast.copyFailed.body': '链接没有复制成功，请从这个看板任务再试一次。',
  'shares.toast.revokeFailed.body': '公开链接仍然有效，请从这个看板任务再试一次。',
  'shares.toast.deliveryFailed.body': '反馈没有投递成功，请从这个看板任务再试一次。',
  ...
  'shares.toast.feedbackUnreadable.body': '点开此看板任务查看收到的文件。',
  ...
  'recentCodex.status.hapiProcessing': 'HAPI Codex 运行中',
  ...
  'recentCodex.direct.error.externalWriter': '这个原生会话正在由另一个 Codex 客户端使用，HAPI 暂时无法发送这条消息。',
  ...
  'recentCodex.fork.progress.body': '正在把原会话上下文复制到新的 HAPI 会话…',
  'recentCodex.fork.failed.title': '无法创建新会话',
  'recentCodex.fork.error.runnerOffline': '所选 runner 已离线。请重新连接后再试。',
  'recentCodex.fork.error.hubUnavailable': 'HAPI 暂时不可用。请重新连接后再试。',
  ...
  'tool.semanticTitle.manage-hapi': '管理 HAPI',
  ...
  'taskStatus.retrying.body': 'HAPI 会在同一个会话里自动重试这条消息。',
  'taskStatus.retrying.bodyWithAttempt': 'HAPI 会在同一个会话里自动重试这条消息（{attempt}）。',
  'taskStatus.compacting.title': '上下文过长，正在压缩后重试',
  'taskStatus.compacting.body': 'HAPI 正在压缩当前会话上下文，然后继续重试。',
  'taskStatus.compacting.bodyWithAttempt': 'HAPI 正在压缩当前会话上下文，然后继续重试（{attempt}）。',
