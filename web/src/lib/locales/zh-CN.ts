export default {
  ...
  'shares.title': '中文看板',
  'shares.back': '返回会话列表',
  'shares.hint': '每个分享文件都是一项任务。可反馈的 Markdown 会在外部 Agent 回传后显示反馈，并可安全送回来源会话审阅。',
  ...
  'shares.cleanupPending.title': '链接已撤销',
  'shares.cleanupPending.body': '公开访问已关闭；HAPI 会稍后再次尝试从磁盘清理文件。',
  ...
  'shares.details.viewFeedback': '查看反馈',
  'shares.details.hideFeedback': '收起反馈',
