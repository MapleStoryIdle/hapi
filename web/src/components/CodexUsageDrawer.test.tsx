...
describe('iOS Codex usage drawer', () => {
    ...
    it('shows raw input, cached input, output, reasoning output, and model-effort breakdown', () => {
        ...
        expect(screen.getByTestId('codex-usage-input-metric')).toHaveTextContent('Input1K')
        expect(screen.getByTestId('codex-usage-cached-input-metric')).toHaveTextContent('Cached input80080%')
        expect(screen.getByTestId('codex-usage-cache-ratio')).toHaveTextContent('80%')
