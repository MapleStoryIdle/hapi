...
export function MonitorWebhookAccess(props: { api: ApiClient; monitorId: string; baseUrl: string; t: (key: string) => string; onRotate: () => void }) {
    ...
    if (token) return <MonitorTokenReveal token={token} baseUrl={props.baseUrl} t={props.t} />
